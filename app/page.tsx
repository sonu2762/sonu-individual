      ...
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse  bg-[#35938D]">
          ...
          <div>
            ...
            <p className=" mt-6 text-5xl font-bold text-[#5A1EBC]">MCA/MSM-Business Analyst<span className='text-[#E79D0F]'>  Specialist</span></p>
            ...
            <div className='flex gap-20 mt-32'>
              <div>
                <span className={'font-bold text-6xl text-[#1F5DFC]'}>80+</span>
                <p className=' text-xl'>Tech skill</p>
              </div>
              <div>
                <span className={'font-bold text-6xl text-[#1F5DFC]'}>120+</span>
                <p className=' text-xl'>Leadership</p>
              </div>
              <div>
                <span className={'font-bold text-6xl text-[#1F5DFC]'}>5.0</span>
