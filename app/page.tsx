  ...
  return (
    <main>
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse  bg-[#ADD8E6]">
          <Image src="/hero.png" width={410} height={524} sizes="100vw" alt='sa porfolio' className={'mb-16'} />
          <div>
            <p className="text-5xl font-bold text-[#5A1EBC]">Hi ! I&apos;m Sonu Aggarwal </p>
            <p className=" mt-6 text-5xl font-bold text-[#5A1EBC]">MCA/MSM-Business Analyst<span className='text-[#E79D0F]'> </span></p>
            <p className="py-6" style={{ width: '100%', wordBreak: 'break-word', whiteSpace: 'pre-wrap' }} >Creating a collaborative learning environment, promoting teamwork and peer learning.</p>
            <div className=' mt-6'>
              ...
              <div className='flex gap-11 mt-8'>
                ...
                <div className='flex gap-1'>
                  ...
                  <a href='https://github.com/sa2762'>
                    <span>
                      Github
                    </span>
                  </a>
            ...
            <div className='flex gap-20 mt-32'>
              <div>
                <span className={'font-bold text-6xl text-[#1F5DFC]'}>60+</span>
                <p className=' text-xl'>Tech skill</p>
              </div>
              <div>
                <span className={'font-bold text-6xl text-[#1F5DFC]'}>105+</span>
                <p className=' text-xl'>Leadership</p>
              </div>
              <div>
                <span className={'font-bold text-6xl text-[#1F5DFC]'}>4.0</span>
                <p className=' text-xl'>over rate</p>
              </div>
            </div>
          </div>
        </div>
